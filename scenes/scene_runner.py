...
MIN_ENCOUNTERS_BEFORE_BOSS = 5 # Minimum encounters before you get to the boss.
MAX_ENCOUNTERS_BEFORE_BOSS = 10 # Maximum encounters before you get to the boss.
...
def runPath(player, pathsFile="data/paths.json"):
    ...
    current = "prologue"
    enemyEncountersDone = 0 # Encounters done. Only counts enemy encounters
    ...
    while True:
        ...
        if scene.get("encounter_type") == "boss":
            ...
            if enemyEncountersDone < MIN_ENCOUNTERS_BEFORE_BOSS:
            ...
            if survived:
                slowPrint("YOU WIN! The boss has been defeated!")
            else:
                break
        ...
        if "next" in scene:
            ...
            if enemyEncountersDone >= MAX_ENCOUNTERS_BEFORE_BOSS:
